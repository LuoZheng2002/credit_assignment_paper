...
Qwen2.5-7B no-tool & \ours, forced token & 6 & 0,10,\ldots,70 & \acc{0.6436}{0.0025} & 50 & \acc{0.6523}{0.0016} & \best{+0.0087} & \acc{0.6494}{0.0035} \\
\hline
Qwen2.5-7B + tool & GRPO & 6 & 0,10,\ldots,70 & \best{\acc{0.6142}{0.0033}} & 30 & \best{\acc{0.6246}{0.0024}} & \best{+0.0104} & \acc{0.6171}{0.0046} \\
Qwen2.5-7B + tool & \ours, forced token & 6 & 0,10,\ldots,70 & \acc{0.6134}{0.0034} & 50 & \acc{0.6236}{0.0033} & +0.0101 & \best{\acc{0.6181}{0.0016}} \\
\hline
...
Llama-3.1 no-tool & \ours & 6 & 0,10,\ldots,40 & \best{\acc{0.4454}{0.0035}} & 40 & \acc{0.4589}{0.0029} & +0.0135 & \acc{0.4589}{0.0029} \\
\hline
\end{tabular}%
}
...
\hline
Qwen2.5-7B no-tool & Base & \best{\acc{0.6034}{0.0030}} & \best{\acc{0.7400}{0.0056}} & \best{\acc{0.6160}{0.0211}} & \best{\acc{0.5400}{0.0480}} & \best{\acc{0.6000}{0.0511}} & \best{\acc{0.7204}{0.0029}} & \best{\acc{0.6366}{0.0145}} \\
Qwen2.5-7B no-tool & GRPO & -- & -- & -- & -- & -- & -- & 0.6353 \\
Qwen2.5-7B no-tool & \ours, non-forced token & -- & -- & -- & -- & -- & -- & \acc{0.6294}{0.0085} \\
\hline
Qwen2.5-7B + tool & Base & -- & -- & -- & -- & -- & -- & 0.5742 \\
Qwen2.5-7B + tool & GRPO & \acc{0.5808}{0.0065} & \best{\acc{0.6986}{0.0053}} & \acc{0.5580}{0.0114} & \best{\acc{0.4750}{0.0410}} & \best{\acc{0.5385}{0.0413}} & \acc{0.6508}{0.0029} & \acc{0.5836}{0.0148} \\
Qwen2.5-7B + tool & \ours, non-forced token & \best{\acc{0.5940}{0.0039}} & 0.6950 & \best{0.5700} & 0.4500 & \best{0.5385} & \best{0.6540} & \best{\acc{0.5880}{0.0079}} \\
\hline
Qwen3-4B no-tool & Base & 0.5610 & -- & -- & -- & -- & -- & 0.6941 \\
Qwen3-4B no-tool & GRPO & \acc{0.6846}{0.0038} & \acc{0.8250}{0.0069} & \acc{0.6340}{0.0078} & \best{\acc{0.6250}{0.0219}} & \acc{0.7231}{0.0369} & \acc{0.7078}{0.0042} & \acc{0.6999}{0.0037} \\
Qwen3-4B no-tool & \ours & \best{0.6850} & \best{0.8280} & \best{0.6600} & 0.5500 & \best{0.7308} & \best{0.7470} & \best{0.7001} \\
\hline
Qwen3-4B + tool & Base & 0.6090 & 0.7560 & -- & -- & -- & 0.3916 & 0.6255 \\
Qwen3-4B + tool & GRPO & 0.6280 & 0.7730 & -- & -- & -- & -- & 0.6487 \\
Qwen3-4B + tool & \ours & -- & -- & -- & -- & -- & -- & \best{0.6694} \\
\hline
Gemma-3-4B no-tool & Base & \acc{0.4765}{0.0167} & \best{0.7680} & 0.5600 & \best{0.4750} & \best{0.6154} & \best{0.6520} & 0.5819 \\
Gemma-3-4B no-tool & GRPO & \best{0.4850} & 0.7580 & \best{0.5800} & 0.4500 & 0.5385 & 0.6470 & 0.5782 \\
Gemma-3-4B no-tool & \ours & -- & -- & -- & -- & -- & -- & \best{0.5906} \\
\hline
Mistral-7B no-tool & Base & 0.1970 & 0.1370 & 0.1600 & \best{0.0250} & \best{0.1154} & \best{0.2038} & 0.1664 \\
Mistral-7B no-tool & GRPO & \best{0.2120} & \best{0.1530} & \best{0.2600} & \best{0.0250} & \best{0.1154} & 0.1750 & \best{0.1674} \\
Mistral-7B no-tool & \ours & -- & -- & -- & -- & -- & -- & 0.1567 \\
\hline
Llama-3.1 no-tool & Base & 0.3180 & -- & -- & -- & -- & -- & 0.3926 \\
Llama-3.1 no-tool & GRPO & \best{\acc{0.3666}{0.0111}} & \best{\acc{0.5168}{0.0071}} & \best{\acc{0.4340}{0.0159}} & \best{\acc{0.2750}{0.0268}} & \best{\acc{0.4077}{0.0452}} & \best{\acc{0.4688}{0.0051}} & \acc{0.4117}{0.0086} \\
Llama-3.1 no-tool & \ours & -- & -- & -- & -- & -- & -- & \best{0.4167} \\
\hline
\end{tabular}%
}
\caption{Held-out serious-test results by dataset. Values are pass@1 accuracies; dashes mark entries whose repaired per-dataset artifacts are still pending. Confidence intervals are shown when available from per-trial score artifacts. Bold underlined entries mark the largest value within each model-condition comparison block. Table~\ref{tab:forced-token-results} separately compares forced and non-forced TreeMAPPO variants.}
...
Qwen2.5-7B no-tool & GRPO & 30 & 5 & recovery pending \\
Qwen2.5-7B no-tool & \ours, non-forced token & 20 & 5 & recovery pending \\
\hline
Qwen2.5-7B + tool & Base & 0 & 5 & recovery pending \\
Qwen2.5-7B + tool & GRPO & 30 & 5 & 6/6 \\
Qwen2.5-7B + tool & \ours, non-forced token & 70 & 5 & recovery pending \\
\hline
Qwen3-4B no-tool & Base & 0 & 5 & recovery pending \\
Qwen3-4B no-tool & GRPO & 50 & 5 & 6/6 \\
Qwen3-4B no-tool & \ours & 30 & 5 & recovery pending \\
\hline
Qwen3-4B + tool & Base & 0 & 5 & recovery pending \\
Qwen3-4B + tool & GRPO & 40 & 5 & recovery pending \\
Qwen3-4B + tool & \ours & 50 & 5 & recovery pending \\
\hline
Gemma-3-4B no-tool & Base & 0 & 5 & recovery pending \\
Gemma-3-4B no-tool & GRPO & 50 & 5 & recovery pending \\
Gemma-3-4B no-tool & \ours & 40 & 5 & recovery pending \\
\hline
Mistral-7B no-tool & Base & 0 & 5 & recovery pending \\
Mistral-7B no-tool & GRPO & 40 & 5 & recovery pending \\
Mistral-7B no-tool & \ours & 20 & 5 & recovery pending \\
\hline
Llama-3.1 no-tool & Base & 0 & 5 & recovery pending \\
Llama-3.1 no-tool & GRPO & 30 & 5 & 6/6 \\
Llama-3.1 no-tool & \ours & 40 & 5 & recovery pending \\
\hline
\end{tabular}%
}
\caption{Checkpoint-selection and artifact-coverage table for the serious tests in Table~\ref{tab:heldout-serious}. Recovery-pending rows have submitted repair jobs to regenerate or rescore per-trial, per-dataset artifacts under the current judging/scoring path.}
\label{tab:test-checkpoints}
\end{table}

The serious tests sharpen the conclusion. In no-tool Qwen2.5-7B, neither trained method beats the base model on the six-dataset macro average despite validation gains, indicating limited transfer from the validation mixture. In tool-enabled Qwen2.5-7B, both trained methods improve over base by about one point, with the non-forced \ours\ row slightly ahead. Qwen3-4B is the strongest positive setting: both methods improve in no-tool testing, and \ours\ substantially outperforms GRPO in the tool setting. Gemma and Llama provide additional positive evidence for \ours\ over their base models, while Mistral remains unstable and below base for \ours.
...
\hline
Qwen2.5-7B no-tool & Non-forced token & 20 & 0.6493 & 20 & \acc{0.6294}{0.0085} \\
Qwen2.5-7B no-tool & Forced token & 50 & \best{\acc{0.6523}{0.0016}} & 50 & \best{\acc{0.6305}{0.0081}} \\
\hline
Qwen2.5-7B + tool & Non-forced token & 70 & \acc{0.6193}{0.0047} & 70 & \best{0.5880} \\
Qwen2.5-7B + tool & Forced token & 50 & \best{\acc{0.6236}{0.0033}} & 50 & \acc{0.5836}{0.0119} \\
\hline
\end{tabular}%
}
...
\hline
GRPO baseline & 30 & 0.6468 & \best{0.6538} & +0.0069 & 30 & \best{0.6353} \\
\ours, non-forced token & 20 & 0.6439 & 0.6493 & +0.0054 & 20 & \acc{0.6294}{0.0085} \\
\ours, forced token & 50 & 0.6436 & 0.6523 & +0.0087 & 50 & \acc{0.6305}{0.0081} \\
TEMPO-style branching & 70 & 0.6392 & 0.6521 & \best{+0.0129} & 70 & \acc{0.6326}{0.0144} \\
TreeRPO-style credit & 40 & 0.6433 & 0.6520 & +0.0087 & 40 & \acc{0.6272}{0.0054} \\
TreeRL-style branching & 20 & 0.6403 & 0.6490 & +0.0087 & 20 & \acc{0.6195}{0.0069} \\
TreeRL-style credit & 60 & \best{0.6487} & 0.6523 & +0.0036 & 60 & \acc{0.6334}{0.0062} \\
TreeRL combined & 40 & 0.6437 & 0.6522 & +0.0085 & 40 & \acc{0.6341}{0.0110} \\
Branch budget 8 & 10 & 0.6434 & 0.6501 & +0.0067 & 10 & \acc{0.6274}{0.0076} \\
Branch budget 32 & 60 & 0.6439 & 0.6509 & +0.0070 & 60 & \acc{0.6333}{0.0105} \\
\hline
\end{tabular}
}
\caption{Qwen2.5-7B no-tool ablations. Validation numbers are held-out macro averages; testing uses five trials and six datasets. Confidence intervals are shown when available from per-trial score artifacts. Ablation validation rows are directional when their validation trial count differs from the six-trial main rows, but their serious-test scores use the same five-trial testing protocol. Bold underlined entries mark the largest value in each numeric column.}
