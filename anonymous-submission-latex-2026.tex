...
\section{Results}
This section contains result placeholders to be replaced with final measured statistics. All non-result sections describe the implemented method and evaluation protocol.
...
\hline
Qwen2.5-7B + tool & Base & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Qwen2.5-7B + tool & GRPO & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Qwen2.5-7B + tool & \ours & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
\hline
Qwen2.5-7B no-tool & Base & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Qwen2.5-7B no-tool & GRPO & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Qwen2.5-7B no-tool & \ours & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
\hline
Qwen3-4B + tool & Base & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Qwen3-4B + tool & GRPO & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Qwen3-4B + tool & \ours & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
\hline
Qwen3-4B no-tool & Base & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Qwen3-4B no-tool & GRPO & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Qwen3-4B no-tool & \ours & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
\hline
Gemma-3-4B-IT no-tool & Base & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Gemma-3-4B-IT no-tool & GRPO & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Gemma-3-4B-IT no-tool & \ours & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
\hline
Llama-3.1 no-tool & Base & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Llama-3.1 no-tool & GRPO & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Llama-3.1 no-tool & \ours & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
\hline
Mistral-7B no-tool & Base & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Mistral-7B no-tool & GRPO & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Mistral-7B no-tool & \ours & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
\hline
\end{tabular}%
}
\caption{Main comparison across model families and datasets. Replace placeholders with measured pass@1 mean $\pm$ confidence interval.}
...
Qwen2.5-7B + tool & Base & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Qwen2.5-7B + tool & GRPO & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Qwen2.5-7B + tool & TEMPO-style & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Qwen2.5-7B + tool & TreeRPO-style & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
Qwen2.5-7B + tool & \ours & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder & \placeholder \\
\hline
\end{tabular}%
}
\caption{Ablation framework. The TEMPO-style condition changes the branching policy; the TreeRPO-style condition changes the segment-credit estimator.}
...
\begin{itemize}
    ...
    \item The training loss is an advantage-weighted language-model loss rather than a clipped PPO-ratio objective. This choice keeps the optimization interface simple while preserving the central contribution: tree-based posterior credit assignment.
...
\section{Conclusion}
We presented \ours, a trajectory-tree method for fine-grained credit assignment in agentic LLM training. The core idea is to branch reasoning trajectories at token granularity, infer segment-level contribution and uncertainty from mixed-success descendants, and convert those estimates into training signals for subsequent optimization. The implementation supports the central methodological ingredients, several ablations, tool/no-tool variants, and branch-budget experiments. Together, these components provide a practical route from sparse terminal rewards to localized training signal for long-form reasoning agents.
